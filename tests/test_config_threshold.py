...
def _patch_metrics(monkeypatch: pytest.MonkeyPatch, por: float) -> None:
...
def test_low_por_threshold_blocks_adoption(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
...
def test_high_por_threshold_allows_adoption(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
